...
showDialogFunc2(context, title) {
  ...
  Future<void> insertData(final product) async{
    ...
    firestore.collection("buy_data").add(product).then((DocumentReference document){
...
LogDiaLog(context,String title, String Volume ,int datatotal ){
  ...
  Future<void> insertData(final product) async{
    ...
    firestore.collection("sell_data").add(product).then((DocumentReference document){
      print(document.documentID);
    }).catchError((e){
      print(e);
    });
                      ...
                      Flexible(
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: (val) {
                              if (val == null || val.isEmpty) {
                                return controller.resultdata(double.parse(Volume), 0);
                              }
                              return  controller.resultdata(double.parse(Volume), int.parse(price.text));
                        ...
                        children:[
                          RaisedButton(
                              ...
                              onPressed: (){
                                ...
                                controller.resultdata(controller.count, int.parse(price.text));
                        ...
                        children: [
                          ...
                          CupertinoButton(
                              ...
                              onPressed: () {
                                ...
                                final String btotal = data.toString();
                                bool bcolor = false;

                                if(data>=0) bcolor = true;

                                final ItemSellModel product =
                                ItemSellModel(
                                    title: bname,
                                    // buyDatetime: btime,
                                    sellPrice: bprice,
