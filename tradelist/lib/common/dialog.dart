...
LogDiaLog(context, String title, String Volume, int datatotal) {
  ...
  Future<void> updateData(final result) async {
    firestore
        .collection("month_result").document('00${DateTime.now().subtract(Duration(days:7)).month}')
        .updateData(result)
                        ...
                        children: [
                          ...
                          CupertinoButton(
                              ...
                              onPressed: () {
                                ...
                                insertData(product.toMap());
                                String vtotal = box.read('result2${DateTime.now().subtract(Duration(days:7)).month}');
